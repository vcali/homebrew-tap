class Shellshelf < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/vcali/shellshelf/releases/download/v0.1.0-build.5/combib-aarch64-apple-darwin.tar.gz"
      sha256 "614c56988d268f3af4a9d9935468ad3a13e829c176eea17a2de9397b703d649d"
    else
      url "https://github.com/vcali/shellshelf/releases/download/v0.1.0-build.5/combib-x86_64-apple-darwin.tar.gz"
      sha256 "28ba7f002c8bb1d244e9b9bf717797f1cdfe0235320514b2f28b7309e6568d82"
    end
  elsif OS.linux?
    url "https://github.com/vcali/shellshelf/releases/download/v0.1.0-build.5/combib-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "4bf077aeb6ed7e531bf3305d637e22b2b16aff3bf1c10866509d19daccc3e891"
  end

  def install
    bin.install "combib" => "shellshelf"
  end
